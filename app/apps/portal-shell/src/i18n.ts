...
export const messages = {
  "ja-JP": {
    ...
    profilePasswordChange: "パスワード変更",
    profilePasswordDescription:
      "パスワードでのログインに使用するパスワードを変更します。Windows アカウント認証には影響しません。",
    ...
    profilePasswordChanged: "パスワードを変更しました",
    profilePasswordChangeFailed: "パスワードを変更できませんでした",
    audit: "操作履歴",
    roleInitial: "運",
    roleName: "運用担当者",
  ...
  "zh-CN": {
    ...
    profilePasswordChange: "修改密码",
    profilePasswordDescription:
      "修改密码登录所使用的密码，不影响 Windows 账号认证。",
    ...
    profilePasswordChanged: "密码已修改",
    profilePasswordChangeFailed: "无法修改密码",
    audit: "操作记录",
    roleInitial: "运",
    roleName: "运维负责人",
  ...
  "en-US": {
    ...
    profilePasswordDescription:
      "Change the password used for password sign-in. Windows account authentication is unaffected.",
    ...
    profilePasswordChanged: "The password was changed",
    profilePasswordChangeFailed: "The password could not be changed",
