...
export const messages = {
  "ja-JP": {
    ...
    profilePasswordChange: "LOCAL パスワード変更",
    profilePasswordDescription:
      "LOCAL ログインで使用するパスワードを変更します。Windows SSO には影響しません。",
    profileCurrentPassword: "現在のパスワード",
    profileCurrentPasswordRequired: "現在のパスワードを入力してください",
    profileCurrentPasswordIncorrect: "現在のパスワードが正しくありません",
    profileNewPassword: "新しいパスワード",
    profileNewPasswordRequirements:
      "12文字以上で、大文字、小文字、数字、記号をそれぞれ1文字以上含めてください。",
    profileConfirmPassword: "新しいパスワードの確認",
    profileConfirmPasswordRequired: "新しいパスワードをもう一度入力してください",
    profilePasswordMismatch: "新しいパスワードが一致しません",
    profilePasswordSave: "パスワードを変更",
    profilePasswordChanged: "LOCAL パスワードを変更しました",
    profilePasswordChangeFailed: "LOCAL パスワードを変更できませんでした",
    audit: "操作履歴",
    roleInitial: "運",
    roleName: "運用担当者",
    ...
    modelName: "モデル",
    modelNameHelp: "Endpoint と API Key から取得したモデル一覧で選択してください。",
    modelNameRequired: "モデルを選択してください",
    modelNamePlaceholder: "モデル一覧を取得して選択",
    loadModelList: "モデル一覧を取得",
    modelApiKey: "API Key",
  ...
  "zh-CN": {
    ...
    profilePasswordChange: "修改 LOCAL 密码",
    profilePasswordDescription:
      "修改用于 LOCAL 登录的密码，不影响 Windows SSO。",
    ...
    profileNewPasswordRequirements:
      "至少12个字符，并分别包含大写字母、小写字母、数字和符号。",
    profileConfirmPassword: "确认新密码",
    profileConfirmPasswordRequired: "请再次输入新密码",
    profilePasswordMismatch: "两次输入的新密码不一致",
    profilePasswordSave: "修改密码",
    profilePasswordChanged: "LOCAL 密码已修改",
    profilePasswordChangeFailed: "无法修改 LOCAL 密码",
    audit: "操作记录",
    roleInitial: "运",
    roleName: "运维负责人",
    ...
    modelName: "模型",
    modelNameHelp: "请从 Endpoint 和 API Key 获取的模型列表中选择。",
    modelNameRequired: "请选择模型",
    modelNamePlaceholder: "获取模型列表后选择",
    loadModelList: "获取模型列表",
    modelApiKey: "API Key",
  ...
  "en-US": {
    ...
    profilePasswordChange: "Change LOCAL password",
    profilePasswordDescription:
      "Change the password used for LOCAL sign in. Windows SSO is unaffected.",
    profileCurrentPassword: "Current password",
    profileCurrentPasswordRequired: "Enter the current password",
    profileCurrentPasswordIncorrect: "The current password is incorrect",
    ...
    profileConfirmPasswordRequired: "Enter the new password again",
    profilePasswordMismatch: "The new passwords do not match",
    profilePasswordSave: "Change password",
    profilePasswordChanged: "The LOCAL password was changed",
    profilePasswordChangeFailed: "The LOCAL password could not be changed",
    ...
    modelName: "Model",
    modelNameHelp: "Select from the models loaded with the Endpoint and API Key.",
    modelNameRequired: "Select a model",
    modelNamePlaceholder: "Load and select a model",
