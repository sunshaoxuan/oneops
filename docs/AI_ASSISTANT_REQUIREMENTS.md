...
20. 浮動ウィンドウと全画面の会話本文には固定のクイックナビゲーションを表示する。ユーザー発言と AI 発言を個別の目盛りとして表し、現在の閲覧位置を強調する。目盛りのホバーまたはキーボードフォーカスで役割と本文要約を表示し、選択すると対応発言を会話領域中央へ移動する。
...
34. 会話に発言が存在する場合は固定クイックナビゲーションを表示し、現在位置の追従、要約プレビュー、クリック移動、キーボード操作を浮動ウィンドウと全画面で確認できる。
