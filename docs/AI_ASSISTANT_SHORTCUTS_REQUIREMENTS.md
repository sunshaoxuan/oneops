...
14. 第2階層 Menu は分割 Button Row を位置基準とし、第1階層 Menu と上端を揃える。画面幅が十分な場合は右側、820px 以下では左側へ表示し、Viewport 内で名称、説明、Model、推理強度及び速度を視認できること。
...
18. 全4 Category の第2階層 Menu が Viewport 内で表示され、各クイックアシスタントの名称、説明、開始 Model、推理強度及び速度を選択前に確認できる。
