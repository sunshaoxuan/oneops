...
ブラウザーでは local と正式 HTTPS の `/ui/loader-buttons` を開き、DOM 件数、variant ID、描画要素、横幅、Console、desktop screenshot、mobile screenshot 及び 300ms 間隔の frame screenshot hash を確認した。
