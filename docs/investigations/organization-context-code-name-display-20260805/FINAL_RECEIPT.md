...
状態: 実装、試験、正式ローリング配信及び Browser 受入完了。Git 配信確認中
...
| 6 | 配信中も利用可能とする | 55 件中 55 件 HTTP 200 | 合格 |
| 7 | Browser、Console、Layout、Screenshot | 通常幅、705 px、Console 0 | 合格 |
| 8 | `master`、`origin/master`、`v0.9.3` を一致させる | 最終 Git 配信 | 確認中 |

Git 配信完了後に全項目を先頭から再確認する。
